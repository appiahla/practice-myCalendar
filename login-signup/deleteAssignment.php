<?php
    ...
    $delete_assignment_id = $_POST['assignment_id'];
    ...
    if (!$link) {
        ...
        $sql =  "DELETE FROM Assignment WHERE assignment_id='$delete_assignment_id' AND assignment_v_number='$get_v'";
        ...
        if (!$link) {
            ...
            if ($assignments = mysqli_query($link,$sql)) {
                ...
                if($rowcount_assignments > 0) { 
                    ...
                    echo "<form action='./deleteAssignment.php' method='POST' id='deleteBtnD'>
                        <input type='hidden' name='assignment_id' value='$assignment_id'>
